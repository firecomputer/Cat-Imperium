# Cat Empire — 1차 설계 계획서 (v0.1)

> **이 문서의 목적**: Godot 4.x 기반 관전형 문명 시뮬레이션 게임 "Cat Empire"의 전체 시스템 설계를 정의한다. 구현자(Claude Code)는 이 문서를 단일 진실 공급원(SSOT)으로 삼아 마일스톤 순서대로 작업한다.
